  ...
  var ResolutionMenuItem = videojs.extend(MenuItem, {
        	...
        	function getAttr(elem, attr) {
             ...
             menuItems.push(new ResolutionMenuItem(
              this.player_,
              {
                label: key,
                src: labels[key],
                initialySelected: getAttr(labels[key], "default") || getAttr(labels[key], "selected") || getAttr(labels[key], "index") == 0,
                customSourcePicker: this.options_.customSourcePicker
              },
    ...
    videoJsResolutionSwitcher = function(options) {
      ...
      player.updateSrc = function(src){
        ...
        var defaultSrc = OV.array.search(true, src, function(val, src){ return src.default == true || src.index == 0; });
        player.src(defaultSrc);
        if(defaultSrc) {
        	return setSourcesSanitized(player, [defaultSrc], defaultSrc.label);
        }
        else {
