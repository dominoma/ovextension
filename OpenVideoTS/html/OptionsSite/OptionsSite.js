...
document.addEventListener("DOMContentLoaded", function () {
    ...
    SwitchesTable.onchange = function () {
        SwitchesTable.querySelectorAll("input[type=checkbox]").forEach(function (Switch) {
    ...
    otherOptionsTable.onchange = function () {
        OV.storage.sync.set("disableHistory", !document.getElementById("options_site_enable_history_ckb").checked);
        ScriptBase.setScriptEnabled("All videos", document.getElementById("options_site_enable_popup_ckb").checked);
        OV.storage.sync.set("AnalyticsEnabled", document.getElementById("options_site_use_analytics_ckb").checked);
        //setSyncStorageItem("showPopupMinimized",document.getElementById("Show Popup minimized").checked);
    };
});
//# sourceMappingURL=OptionsSite.js.map