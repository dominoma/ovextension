...
const navigation_1 = __webpack_require__(38);
const searchbody_1 = __webpack_require__(31);
const videobody_1 = __webpack_require__(41);
const prompts_1 = __webpack_require__(44);
...
module.exports = __webpack_require__.p + "/test_pages/assets/png/9d1c349992b139988b754033a58af680.png";
...
const Storage = __webpack_require__(18);
const Tools = __webpack_require__(20);
const prompt_1 = __webpack_require__(35);
...
class SearchBody extends React.Component {
    ...
    searchBtnSelected(data) {
        return __awaiter(this, void 0, void 0, function* () {
            if (data.url == exports.addSiteSearchBtnData.url) {
                let state = yield prompt_1.PromptManager.openPrompt("addSearchSitePrompt");
                let data = yield SearchBody.resolveBtnData(state);
                console.log(data);
                if (data) {
    ...
    render() {
        let buttonsData = [exports.allSitesSearchBtnData].concat(this.state.sites).concat(exports.addSiteSearchBtnData);
        ...
        return (React.createElement("div", { className: "ov-lib-search" },
            React.createElement(SearchInput, { onSearch: this.inputSearched.bind }),
            React.createElement("div", { className: "ov-lib-search-btn-list" }, buttons)));
    }
...
module.exports = __webpack_require__.p + "/test_pages/assets/png/90fdd872837b2a757eda040e8fb0768f.png";
...
class VideoLink extends React.Component {
    render() {
        ...
        return (React.createElement("div", { className: className },
            React.createElement("div", { onClick: hasParent ? undefined : this.originClick.bind(this), className: "ov-lib-videoref-thumbnail", style: { backgroundImage: "url('" + this.props.videoData.poster + "')" } },
...
/***/ })
/******/ ]);
//# sourceMappingURL=library_test.js.map