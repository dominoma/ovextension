...
class PopupContent extends React.Component {
    ...
    render() {
        ...
        if (this.state.videos.length == 0) {
            ...
            return (React.createElement("div", { className: "ov-videopopup-content" },
                React.createElement("div", { className: "ov-videopopup-header" },
                    React.createElement("h2", null, "OpenVideo found videos!"),
                    React.createElement("div", { className: "ov-videopopup-close", onClick: this.popupClose.bind(this) }, "\u00D7")),
                React.createElement("div", { className: "ov-videopopup-player" },
                    React.createElement(ov_player_1.OVPlayer, { videoData: this.state.videos[this.state.currentVideo], isPopup: true, onError: this.playerError.bind(this) })),
                React.createElement("div", { className: "ov-videopopup-footer" },
                    React.createElement("button", { className: "ov-videopopup-button", onClick: this.prevClick.bind(this) }, "<"),
                    React.createElement("button", { className: "ov-videopopup-button-disabled" }, buttonStr),
                    React.createElement("button", { className: "ov-videopopup-button", onClick: this.nextClick.bind(this) }, ">"))));
        }
    }
    playerError() {
...
ReactDOM.render(React.createElement(PopupContent, { data: Page.getUrlObj() }), document.body);
