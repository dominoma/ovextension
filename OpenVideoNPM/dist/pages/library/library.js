...
function createVideoLink(videoData) {
    return createLibraryElem(videoData.origin, videoData.title, "https://favicons.githubusercontent.com/" + Tools.parseURL(videoData.origin).host, videoData.poster, true, function (VideoLink) {
        return __awaiter(this, void 0, void 0, function* () {
            let VideoHashArr = yield Storage.local.get(Page.getUrlObj().directory);
...
Page.isReady().then(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        document.getElementById("clearBtn").addEventListener("click", function () {
            return __awaiter(this, void 0, void 0, function* () {
                let doDelete = yield Background.confirm("Are you sure you want to clear the video history?\n Your favorites won't be affected.");
                if (doDelete) {
        ...
        if (!Hash) {
            ...
            let VideoHashArr = yield Storage.local.get(Hash.directory);
