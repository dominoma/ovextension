...
const OVPlayer = __webpack_require__(139);
...
const Languages = __webpack_require__(51);
const OVPlayerComponents = __webpack_require__(140);
        ...
        setFavorite: function (value, dontSet) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!dontSet) { //Storage.local.get("OpenVideoFavorites") OpenVideoHistory
                    let favorites = yield Storage.getPlaylistByID(Storage.fixed_playlists.favorites.id);
                    if (!favorites) {
                        favorites = [];
                    }
                    var entryIndex = favorites.findIndex(function (arrElem) {
                        return arrElem.origin.url == _this.player_.getVideoData().origin.url;
                    });
                    if (entryIndex != -1) {
                    ...
                    yield Storage.setPlaylistByID(Storage.fixed_playlists.favorites.id, favorites);
                }
            });
        },
